...
object AggregationsRDD {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val session: SparkSession = createSession(2, "Aggregations RDD")
    ...
    ////////////////////////////////////////////////////
    val tokenWithNeighbours: RDD[(String, Int)] = lines.flatMap(getNeighbours)
