...
if __name__ == "__main__":
    ...
    session: SparkSession = create_session(2, "Activity 3")
    lines: RDD = session.sparkContext.textFile(novella_location).cache()
    tokens: RDD = lines.flatMap(lambda line: line.split()).cache()
