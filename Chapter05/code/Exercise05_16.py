dfPopulation1 = spark.read.option("header", "true").csv("Chapter05/data/population.csv")
dfPopulation2 = spark.read.option("header", "true").csv("Chapter05/data/population_add.csv")
dfPopulation1.show()
dfPopulation2.show()
