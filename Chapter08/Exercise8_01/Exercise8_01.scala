...
object Exercise8_01 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    .setInputCols( Array("CRIM", "ZN", "INDUS", "CHAS", "NOX", "RM", "AGE", "DIS", "RAD", "TAX", "PT", "B", "LSTAT"))
    .setOutputCol("features")
    
    val vectorAssemblerFeaturesAndLabel = new VectorAssembler()
    .setInputCols( Array("CRIM", "ZN", "INDUS", "CHAS", "NOX", "RM", "AGE", "DIS", "RAD", "TAX", "PT", "B", "LSTAT","label"))
    .setOutputCol("featuresAndLabel")
